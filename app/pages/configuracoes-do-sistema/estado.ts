...
export const indiceDeBusca: ItemDeBusca[] = [
  ...
  { aba: 'basicas', secao: 'comportamento', rotulo: 'Correção monetária', sinonimos: ['ipca', 'igpm', 'índice', 'reajuste', 'valor'] },
  { aba: 'basicas', secao: 'comportamento', rotulo: 'Comparações', sinonimos: ['comparar itens'] },
  { aba: 'basicas', secao: 'comportamento', rotulo: 'Jurídico', sinonimos: ['processo', 'prazo judicial'] },

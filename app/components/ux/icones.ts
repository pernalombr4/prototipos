// Biblioteca de ícones do seletor. GERADA A PARTIR DO @iconify-json/lucide
// INSTALADO. Não edite à mão.
//
// A biblioteca real do ENSPACE passa de 50 mil ícones. Aqui estão os do Lucide
// que existem offline neste repositório: suficiente para provar o que muda com
// escala, que é a busca virar navegação e a grade ser virtualizada.
//
...
//
// Esta cópia mora em `app/components/ux/` porque o seletor virou componente
// compartilhado. O protótipo `tela-de-workspaces` ainda tem a sua própria
// cópia local; quando ele migrar, os dois passam a ler daqui.
